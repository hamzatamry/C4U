    ...
    private void askLocationPermission() {
        Dexter.withContext(this).withPermission(Manifest.permission.ACCESS_FINE_LOCATION).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                ...
                // set the default location Marker to last known position
                ...
                mMap.clear();
                mMap.addMarker(new MarkerOptions().position(userLatLong).title("Your are Here"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(userLatLong));

                //LatLng casablanca = new LatLng(-34, 151);
                //mMap.addMarker(new MarkerOptions().position(casablanca).title("Marker in Sydney"));
